...
export const getAllProductRandom = async({query="pantalon", page=861, category_id="fashion", min_price=20, max_price=100, brand=["adidas", "Lee", "amazon essentials", "Dockers"]})=>{
    console.log("Esperando ...................")
